...
//todos os métodos na classe são retornos de dados diretamente serializados para o corpo da resposta HTTP
...
public class PostagemController {
	...
	@DeleteMapping("/{id}") //usamos o response pq o delete não tem status
